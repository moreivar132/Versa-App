...
async function chat(req, res) {
    try {
        ...
        await req.db.txWithRLS(async (tx) => {
            ...
            const empresaCheck = await tx.query(empresaQuery, empresaParams);
            ...
            const assistantMsgResult = await tx.query(`
...
async function getInsights(req, res) {
    try {
        ...
        const empresaCheck = await req.db.query(empresaQuery, empresaParams);
        ...
        const insights = await insightsService.generateInsights(empresaId, period, tenantId);
